  ...
  return (
    <div className="ml-0 w-2/4 p-20 mt-10 bg-white rounded-2xl shadow-md">
      ...
      <form onSubmit={handleSubmit}>
        <div className="mb-4">
          <p className="text-gray-600 text-sm mt-2">Пожалуйста, опишите свою проблему в поле ниже</p>
          <label htmlFor="message" className="block text-sm mb-2"></label>
          <textarea
            id="message"
        ...
        <div className="mb-4">
          <p className="text-gray-600 text-sm mt-2">Вы можете прикрепить скриншот с вашей проблемой</p>
